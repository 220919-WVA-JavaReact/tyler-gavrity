...
public class CollectionDriver {
    ...
    public static void main(String[] args) {
         ...
         *
         * The Java platform contains two general-purpose List implementations. ExamplesLinkedList, which performs well when adding or removing from
         * the collection frequently. A ExampleArrayList which offers better performance when the collection will be accessed frequently (get and
         * set methods).
         */
